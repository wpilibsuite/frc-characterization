...
class TestRunner:
    ...
    def wait_for_stationary(self):
        ...
        logger.info("Waiting for the flywheel to stop moving for at least 1 second...")
    ...
    def ramp_voltage_in_auto(self, initial_speed, ramp, rotate):
        ...
        logger.info(
            "Activating flywheel at %.1f%%, adding %.3f per 50ms", initial_speed, ramp
        )
        ...
        try:
            ...
            if len(data) < 3:
                ...
                self.STATE.postTask(
                    lambda: messagebox.showinfo(
                        name + " Complete",
                        "The flywheel reported traveling the following distance:\n"
                        + "%.3f units" % distance
                        + "\n"
