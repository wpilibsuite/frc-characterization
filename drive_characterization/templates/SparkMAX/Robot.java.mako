...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    CANSparkMax leftMaster = new CANSparkMax(${lports[0]});
    % if linverted[0] ^ turn:
    ...
    CANSparkMax rightMaster = new CANSparkMax(${rports[0]});
    % if linverted[0]:
    ...
    CANSparkMax leftSlave${loop.index} = new CANSparkMax(${port});
    ...
    CANSparkMax rightSlave${loop.index} = new CANSparkMax(${port});
