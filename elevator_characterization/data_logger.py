...
class DataLogger:
    ...
    def ramp_voltage_in_auto(self, initial_speed, ramp):
        ...
        logger.info(
            "Activating elevator at %.1f%%, adding %.3f per 50ms", initial_speed, ramp
        )
    ...
    def run(self):
        ...
        for i, (name, initial_speed, ramp) in enumerate(autonomous):
            ...
            print("before the elevator hits something!")
            print("")
            ...
            if len(data) < 3:
                ...
                print()
                print("The robot elevator reported traveling the following distance:")
                print()
                print("Left:  %.3f feet" % distance)
                print()
                print(
